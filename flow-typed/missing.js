...
declare module 'redux-saga/effects' {
  ...
  declare type AllEffect<T> = $npm$ReduxSaga$IOEffect & {
    ALL: $Shape<T>,
  }
  ...
  declare type AllFn = {
    <T: {[key: string]: IOEffect} | Array<IOEffect>>(effects: T): AllEffect<T>;
  }
  ...
  declare type RaceFn = {
    <T: {[key: string]: IOEffect} | Array<IOEffect>>(effects: T): RaceEffect<T>;
  }
